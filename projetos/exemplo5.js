/* Critérios:
    ...
    É esperado um RPS de 200 REQ/s para a API de listagem
    de crocodilos durante 30 seg.
    Para a busca por id, o sistema deve atender 50 usuários
    onde cada usuário realiza até 20 solicitações em até 1 min
